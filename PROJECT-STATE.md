...
- 流程：负责人可修正本节点实际完成日期（已设置时间不再完全锁死，修正留审计），管理员/总经理不受限
...
- 测试：API 71 项、后端单元 93 项、前端 Vitest 20 项、压力测试（并发建单/阶段推进/50 单导出）、E2E、依赖审计
...
- `migrations/`：PostgreSQL 自动迁移（30 个版本：001-024、026、027、028、029、030、031；025 已撤销）
