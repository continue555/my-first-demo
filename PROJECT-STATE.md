...
- 实际联动：节点实际完成/开始相对计划推迟或提前时，自动顺延/提前下游“未开始且非人工设置”节点的计划日期并通知受影响部门（迁移 026 新增 `planned_end_source` 区分自动/人工）
...
- 测试：API 63 项、后端单元 92 项、前端 Vitest 19 项、压力测试（并发建单/阶段推进/50 单导出）、E2E、依赖审计
