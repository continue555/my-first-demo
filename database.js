...
async function seedData() {
  ...
  const users = [[1,"admin",hash,"系统管理员",null,"admin"],[2,"zongjingli",hash,"黄华任",null,"management"],[3,"xiaoshou1",hash,"张销售",1,"sales"],[4,"xiaoshou2",hash,"李销售",1,"sales"],[6,"jishu1",hash,"张翠霞",4,"production"],[7,"caigou1",hash,"夏强",5,"production"],[8,"cangku1",hash,"黄华检",6,"production"],[9,"zhuangpei1",hash,"吴国银",7,"production"],[10,"tiaoshi1",hash,"罗永伟",8,"production"],[11,"caiwu1",hash,"钟肖冰",3,"finance"],[12,"fahuo1",hash,"黄华新",9,"production"],[13,"shenpi1",hash,"孙有威",10,"production"],[15,"wuliao1",hash,"莫叶",12,"material_follow"],[29,"mujv1",hash,"胡彩静",11,"mold"]];
